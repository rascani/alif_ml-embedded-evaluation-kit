...
This page records the measured ET v6 / TFLM v3 **SRAM baseline**. The
[current comparison](e8_tiny_current_summary.md) includes the later integer-pooling
results. The [profile table](e8_tiny_profile_comparison.md) keeps logging on/off separate.
